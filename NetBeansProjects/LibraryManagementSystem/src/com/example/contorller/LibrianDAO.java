...
public class LibrianDAO {
    ...
    public void insertLibrian(Librian ob){
        try{
            Connection con=DBConnection.getConnection();
            String sql="insert into librian (name,faculty,gender,email,imagename) values (?,?,?,?,?)";
     ...
     public ArrayList<Librian> viewLibrian(){
      ArrayList<Librian> list=new ArrayList();
      try{
          Connection con=DBConnection.getConnection();
          String sql="select * from librian";
    ...
    public void updateLibrian(Librian ob){
        try{
            Connection con=DBConnection.getConnection();
    ...
    public void deleteLibrian(Librian ob){
        try{
            Connection con=DBConnection.getConnection();
            String sql ="Delete  from librian where id=?";
            PreparedStatement pst=con.prepareStatement(sql);
